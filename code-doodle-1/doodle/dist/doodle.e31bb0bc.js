...
function start() {
  ...
  var isInViewport = function isInViewport(elem) {
    var bounding = elem.getBoundingClientRect(); //  If the bottom is in view but the top isn't then it's visible
  ...
  function line(diff, n, hue) {
    ...
    for (var y = 0; y < numOfLines; y++) {
      ...
      var yDiv = y / numOfLines; // Math.sin((Math.PI / 180) * degrees) => 0,0 90,1 180,0 270,-1, 360,0
...
//# sourceMappingURL=/doodle.e31bb0bc.js.map